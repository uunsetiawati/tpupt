                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "koperasi", "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "ukm", "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "lainnya", "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "koperasi", "created", date($tahun), $data->id)->num_rows() + $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "ukm", "created", date($tahun), $data->id)->num_rows() + $this->fungsi->loadDataLike2("tb_kunjungan", "tipe", "lainnya", "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_izin", "user_id", $data->id, "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?= $this->fungsi->loadDataLike2("tb_late", "user_id", $data->id, "created", date($tahun), $data->id)->num_rows() ?></p>
                                                    </td>
                                                    <td>
                                                        <?= $this->fungsi->getPoinTahun($data->id, $tahun)->row("poin") ?>
                                                    </td>
                                                    <!-- <td>
                                                        <?php if ($this->fungsi->loadDataLike1("tb_target", "created", $tahun, $data->id)->num_rows() != null) { ?>
